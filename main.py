...
st.markdown(
    "<h1 style='white-space: nowrap;'>LendSafe Finance: Credit Risk Modelling</h1>",
    unsafe_allow_html=True
)

# # Set the page configuration and title
st.set_page_config(page_title="LendSafe Finance: Credit Risk Modelling", page_icon="🏦")

# st.title("LendSafe Finance: Credit Risk Modelling")
